...
const ctx = document.getElementById("myChart");
        const data= {labels:products.map((product)=>product.name),
        datasets:[{label:"items",data:products.map((product)=>product.price),
        borderWidth:1,
        backgroundColor:["red","green","blue","orange","indigo","purple"]}]
        }
